...
Pod::Spec.new do |s|
  s.name             = 'SuperUI'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SuperUI.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ixueadev/SuperUI'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ixueadev' => 'ixueadev@163.com' }
  s.source           = { :git => 'https://github.com/ixueadev/SuperUI.git', :tag => s.version.to_s }
